      ...
      body: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            ...
            BoxShadow(blurRadius: 10, spreadRadius: 10, color: Colors.black26),
            BoxShadow(
              blurRadius: 10,
              spreadRadius: 10,
              color: Colors.blueAccent,
            ),
            BoxShadow(blurRadius: 10, spreadRadius: 10, color: Colors.white38),
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            Flexible(flex: 1, child: Text("Job Tittle: MERN Stack Developer")),
            Flexible(flex: 1, child: Text("Email: rashidabdallah4@gmail.com")),
          ],
        ),
      ),
    );
